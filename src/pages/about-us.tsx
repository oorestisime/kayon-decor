            ...
            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                ...
                <p className="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                  ...
                  products that will enrich your home and embrace the beauty of
                  Indonesian culture.
                </p>
              </div>
            ...
            <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
              ...
              <div className="mt-10 max-w-xl text-base leading-7 text-gray-700">
                <p>
                  ...
                  decorative bowls, and exquisite cutting boards. Each piece is
                  carefully handpicked by our founders ensuring a genuine
                  connection with the artisans and their creations.
                </p>
                <p className="mt-10">
                  As a company committed to sustainability and ethical sourcing,
                  we take pride in our partnership with responsible Indonesian
                  suppliers who share our vision for preserving the environment
                  and supporting local communities. We believe in empowering
                  these artisans and creating a positive impact through fair
                  trade practices and eco-conscious business decisions..
                </p>
                <p className="mt-10">
                  At Kayon Décor, we invite you to discover the charm and
                  sophistication of authentic Indonesian teak wood products. Our
                  passion for quality and design shines through in every unique
                  piece we bring to the shores of Cyprus. Join us on this
                  extraordinary journey as we bridge cultures and elevate your
                  living space with the timeless elegance of teak.
                </p>
              </div>
            </div>
